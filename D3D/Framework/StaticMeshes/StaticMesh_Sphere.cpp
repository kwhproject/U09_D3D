#include "Framework.h"
#include "StaticMesh_Sphere.h"

StaticMesh_Sphere::StaticMesh_Sphere(Shader* shader, float radius, UINT stackCount, UINT sliceCount)
	: StaticMesh(shader)
	, radius(radius)
...
StaticMesh_Sphere::~StaticMesh_Sphere()
{
}

void StaticMesh_Sphere::Create()
{
    vector<VertexMesh> v;
